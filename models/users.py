...
from sqlalchemy import String, Boolean, Enum, func, Date, ForeignKey, BigInteger
...
class UserModel(Base):
    ...
    kyc_status: Mapped[KYCStatus_choice] = mapped_column(
        Enum(KYCStatus_choice, name = "kycstatus"), default = KYCStatus_choice.UNVERIFIED, nullable = False
    )
